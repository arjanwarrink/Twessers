...
class brozzme_scrolltop_settings
{
    ...
    public function bst_float_vertical_padding_render(){
        ...
        ?>
        <input type='text' size="5" name='bst_general_settings[bst_float_vertical_padding]' value='<?php echo $this->options['bst_float_verticals_padding']; ?>'> pixels
    ...
    public function bst_help_section_callback(){
        ...
        <div class="brozzme-info">
            ...
            <ul>
                ...
                <li><?php _e('Divi users can now use Brozzme Scroll Top. The theme back-to-top button is automatically deactived when the plugin is enable.', $this->plugin_text_domain);?>/li>
            </ul>
        </div>
        <div class="brozzme-info">
        ...
        <div class="brozzme-info">
        <p><b><?php _e('View Brozzme (Benoti) plugins on ', $this->plugin_text_domain);?> <a href="https://profiles.wordpress.org/benoti/#content-plugins">WordPress.org</a></b></p>
